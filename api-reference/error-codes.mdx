...
<Info>
  Looking for SMPP protocol-level and MO (Mobile-Originated) delivery error codes instead? See the [Standard SMPP Error Code List](standard-smpp-error-code-list).
</Info>
