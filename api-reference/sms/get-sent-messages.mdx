...
```bash cURL
curl -X GET "https://app.notify.ng/api/v2/SMS?ApiKey=YOUR_API_KEY&ClientId=YOUR_CLIENT_ID&start=0&length=10&fromdate=2024-01-01&enddate=2024-12-31" \
...
const response = await fetch(`https://app.notify.ng/api/v2/SMS?${params}`, {
  method: 'GET',
  headers: {
...
url = "https://app.notify.ng/api/v2/SMS"
params = {
    "ApiKey": "YOUR_API_KEY",
    "ClientId": "YOUR_CLIENT_ID",
    "start": 0,
