---
title: "Introduction"
description: "Powerfull SMS API for sending messages, managing campaigns, and tracking delivery reports"
---
...
<Card title="Get Started" icon="rocket" horizontal href="/api-reference/authentication">
...
<Card title="SMTP email" icon="envelope" horizontal href="/smtp">
